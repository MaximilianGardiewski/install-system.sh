...
# WiFi USB Adapter Dongle T2U 1: Realtek RTL88xxau
WLAN_INTERFACE_T2U_1="wlxe4fac44d1589"

# WiFi USB Adapter Dongle T2U 2: Realtek RTL88xxau
WLAN_INTERFACE_T2U_2="wlxa842a1114c7d"

# WiFi USB Adapter Dongle T2U 3: Realtek RTL88xxau
WLAN_INTERFACE_T2U_3="wlx9c53226a1d24"

# MAC Address of built-in Ethernet interface
MAC_ETH0="d8:3a:dd:39:b3:a8"

# MAC Address of built-in WiFi interface
MAC_WLAN0="d8:3a:dd:39:b3:a9"
...
WIFI_SSID="NotSure"
WIFI_PASSPHRASE="1505lIAsInglEr2000!"
...
echo "${YELLOW}${WLAN_INTERFACE_T2U_1} => USB Adapter Dongle T2U 1 - Chipset Realtek RTL8812AU${RESET}"
echo "${YELLOW}${WLAN_INTERFACE_T2U_2} => USB Adapter Dongle T2U 2 - Chipset Realtek RTL8812AU${RESET}"
echo "${YELLOW}${WLAN_INTERFACE_T2U_3} => USB Adapter Dongle T2U 3 - Chipset Realtek RTL8812AU${RESET}"
...
allow-hotplug ${WLAN_INTERFACE_T2U_1}
iface ${WLAN_INTERFACE_T2U_1} inet static
  address 10.0.0.1
  netmask 255.255.255.0
  up route add -net 10.0.0.0 netmask 255.255.255.0 gw 10.0.0.1
# iface ${WLAN_INTERFACE_T2U_1} inet manual
# ifdown ${WLAN_INTERFACE_T2U_1}


# WiFi USB Adapter Alfa AWUS036NEH Ralink RT2870/RT3070
# Disabled by default at boot
iface ${WLAN_INTERFACE_T2U_2} inet manual
ifdown ${WLAN_INTERFACE_T2U_2}

# WiFi USB Adapter Alfa AWUS036ACH Realtek RTL8812AU
# Disabled by default at boot
iface ${WLAN_INTERFACE_T2U_3} inet manual
ifdown ${WLAN_INTERFACE_T2U_3}
...
interface=${WLAN_INTERFACE_T2U_1}
dhcp-authoritative
